...
const exportar= (request, response)=> {
    ...
    if(obj.estado){
        ...
        let cadena = ' with poste as ( \n\r'+
                    ...
                    'where a.n_borrado = 0 and a.n_idpl_tipoarmado = 5 \n\r'+
                '), \n\r'+
                'Amortiguador_35 as ( \n\r'+
                ...
                'linea as ( \n\r'+
                    ...
                    'from pl_estructura pe  \n\r'+
                        ...
                        'where pe.n_borrado = 0 and pa.n_idpro_proyecto = $1 and zn.n_idpro_proyecto = $1 and pe.n_version = $2 and zn.n_idpl_zona = $3 and tp.n_idpl_tipolinea = $4 and pl.n_idpl_linea = $5 and pa.n_idpl_tipoarmado = 2\n\r'+
                ...
                'Select p.n_idpl_estructura, a35.n_cantidad as amortiguador_35, a37.n_cantidad as amortiguador_37,  \n\r'+
                    ...
                    'p.n_cantidad ,p.c_codigo from vw_planos e \n\r'+
