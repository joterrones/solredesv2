...
const exportar= (request, response)=> {
    ...
    if(obj.estado){
        ...
        let cadena = 'select pe.n_idpl_estructura, ea.n_idpl_estructuraarmado, pl.c_nombre, pe.c_nro_se, pe.c_circuito, pe.c_codigonodo, pa.c_codigo as codigoap, pa.c_codigo as c_codigoas, \n\r' +
