...
const get = (request, response)=>{
    ...
    if (obj.estado) {        
        ...
        ') \n\r' + 
        'select ins.c_codigo, ins.c_latitud, ins.c_longitud, ins.n_precision, ins.n_altitud, ins.d_fecha, ins.n_id_usercrea,	ins.n_idpl_linea, ins.n_idpl_linea,ins.c_codigoestructura, ins.c_codigoede,	\n\r' + 
        ...
        'inner join mon_inspecciondetalle det on det.n_idmon_inspeccion = ins.n_idmon_inspeccion and det.n_borrado = 0     \n\r' + 
        'inner join pl_armado plar on plar.n_idpl_armado = det.n_idpl_armado and plar.n_borrado = 0 \n\r' + 
